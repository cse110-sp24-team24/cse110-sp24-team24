...
describe("Testing Window Functionality", () => {
  ...
  test("Save note", async () => {
    ...
    // Wait for the cancel button to be visible and clickable
    await page.waitForSelector("#saveNoteButton", { visible: true });
    ...
    // Expect the save button not to be clicked
    expect(isSaveButtonClicked).toBe(true);
  }, 30000);
});
